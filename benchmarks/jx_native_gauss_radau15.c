...
static const double jx_gr15_nodes[JX_GR15_STAGES] = {
    0.0,
...
static const double jx_gr15_weights[JX_GR15_STAGES] = {
    0.015625,
...
static const double jx_gr15_matrix[JX_GR15_STAGES][JX_GR15_STAGES] = {
...
int
jx_native_gauss_radau15_tableau(
    double *nodes,
    double *weights,
    double *matrix)
{
...
int
jx_native_gauss_radau15_integrate(
    int body_count,
