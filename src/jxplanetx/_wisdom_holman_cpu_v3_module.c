...
#define JX_WH_MAP_KERNEL_ID \
    "jx.wisdom-holman.native-complete-map.checkpoint-sync.prototype.v3"
...
jx_wh_integrate_map(PyObject *self, PyObject *args)
{
    ...
    status = jx_wh_loop_integrate_v3(
        body_count,
        checkpoint_count,
...
static PyMethodDef jx_wh_methods[] = {
    {
        ...
        PyDoc_STR(
            ...
            "\n"
            "Run the checkpoint-synchronized screening-only fixed-step "
            "Wisdom--Holman loop against exact-size buffers.")
    },
    {NULL, NULL, 0, NULL}
};
...
static struct PyModuleDef jx_wh_module = {
    ...
    "Private v3 checkpoint-synchronized Wisdom--Holman kernel; screening only.",
    -1,
    jx_wh_methods,
    NULL,
    NULL,
...
PyMODINIT_FUNC
PyInit__wisdom_holman_cpu_v3(void)
{
#ifdef __VERSION__
