...
static struct PyModuleDef jx_module = {
    ...
    "_gr15_v3_cpu",
    "Private compiled GR15 V3 qualification candidate.",
    -1,
    jx_methods,
    NULL,
    NULL,
...
PyInit__gr15_v3_cpu(void)
{
    ...
    if (PyModule_AddIntConstant(module, "MAX_BODIES", JX_GR15_MAX_BODIES) < 0
        ...
        || PyModule_AddStringConstant(
            module, "METHOD_ID", "JX_GAUSS_RADAU15_V3") < 0
        || PyModule_AddStringConstant(
