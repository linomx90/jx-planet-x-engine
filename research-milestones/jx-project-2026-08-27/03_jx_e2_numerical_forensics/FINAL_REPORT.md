...
The locally pre-output hash-locked IAS15 reference gate failed in both frames for every
...
The content lock had no independent external timestamp and is not represented
here as an externally preregistered study.
